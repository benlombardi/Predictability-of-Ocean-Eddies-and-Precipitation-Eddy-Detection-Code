...
1) Running the Detection and Tracking Algorithm:
    ...
    - To run the tracking code you can run EddyTracking conf_*.yaml via the command line. This will build to the eddy datasets. Two example yaml files are provided in this repo. You will need to run the EddyTracking command for both the model data and the observational SSH data.
